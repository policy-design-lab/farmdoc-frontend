	...
	render() {
		...
		if (resultData) {
			...
			if (futuresCode) {
				...
				const chartData = generateChartData(previousSolution.sigma, previousSolution.mu);
				...
				priceTableData = regeneratePriceTableData(price, previousSolution.sigma, previousSolution.mu);
				probTableData = generateProbPoints(previousSolution.sigma, previousSolution.mu);
			...
			return (
				<Grid container>
					...
					<Grid container>
						...
						<Grid item xs={3}>
							<div style={{width: "100%", marginTop: "30px", padding: "10px"}}>
								<ReactTabulator
									data={table1.data} layout={"fitColumns"} columns={table1.columns}
					...
					<Grid container>
						...
						<Grid item xs={3}>
							<div style={{width: "100%", marginTop: "00px", padding: "10px"}}>
								<ReactTabulator
									data={table2.data} layout={"fitColumns"} columns={table2.columns}
