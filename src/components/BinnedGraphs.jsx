...
class BinnedGraphs extends Component {
	...
	render() {
		...
		if (jsonData !== null) {
			...
			if (objData.histograms_of_county_plc_payments && objData.histograms_of_county_plc_payments !== null) {
			...
			let normalizedBins = this.normalizeBinSizes(arcBins, plcBins);
			...
			return (
				<div >
					...
					<Grid container style={{width: "1120px"}} >

						<Grid item style={{padding: "1px", width: "48%", borderStyle: "none", boxShadow: " 0 2px 4px 0px", backgroundColor: "Orange"}}>
						...
						<Grid item style={{width: "4%", borderStyle: "none"}} />

						<Grid item style={{padding: "1px", width: "48%", borderStyle: "none", boxShadow: " 0 2px 4px 0px", backgroundColor: "SkyBlue"}}>
						...
						<Grid item style={{width: "48%"}} className="bin-griditem">
							<Bar key="line-2" data={arcData} options={chartOptions} height={250} />
						</Grid>

						<Grid item style={{width: "4%"}} />

						<Grid item style={{width: "48%"}} className="bin-griditem">
							<Bar key="line-3" data={plcData} options={chartOptions} height={250} />
						</Grid>
					</Grid>
